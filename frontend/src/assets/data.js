...
const questionsData = {
  ...
  c: {
    basic: [
      { id: 1, question: "Which file extension is commonly used for C source files?", options: [".c", ".cpp", ".h", ".cs"], correctAnswer: 0 },
      { id: 2, question: "Which function prints output to the console?", options: ["echo()", "cout <<", "printf()", "System.out.println"], correctAnswer: 2 },
      { id: 3, question: "Which header is needed for printf()?", options: ["<stdio.h>", "<stdlib.h>", "<string.h>", "<iostream>"], correctAnswer: 0 },
      { id: 4, question: "Which keyword declares a constant?", options: ["constant", "const", "static", "final"], correctAnswer: 1 },
      { id: 5, question: "Which symbol starts a single-line comment in C?", options: ["//", "#", "<!--", "--"], correctAnswer: 0 },
      { id: 6, question: "Which operator is used to get the address of a variable?", options: ["*", "&", "@", "%"], correctAnswer: 1 },
      { id: 7, question: "Which loop repeats while a condition is true?", options: ["for", "while", "do-while", "repeat"], correctAnswer: 1 },
      { id: 8, question: "How do you declare an integer variable?", options: ["int x;", "integer x;", "num x;", "var x;"], correctAnswer: 0 },
      { id: 9, question: "Which keyword allocates dynamic memory?", options: ["new", "malloc", "allocate", "create"], correctAnswer: 1 },
      { id: 10, question: "What is the correct main function signature?", options: ["main()", "int main()", "void main()", "start()"], correctAnswer: 1 },
      { id: 11, question: "Which header is required for malloc() and free()?", options: ["<memory.h>", "<malloc.h>", "<stdlib.h>", "<alloc.h>"], correctAnswer: 2 },
      { id: 12, question: "Which data type stores a single character?", options: ["char", "string", "text", "letter"], correctAnswer: 0 },
      { id: 13, question: "Which format specifier prints integers?", options: ["%d", "%c", "%f", "%s"], correctAnswer: 0 },
      { id: 14, question: "What does sizeof return?", options: ["Byte size of data type", "Length of string", "Number of digits", "Memory address"], correctAnswer: 0 },
      { id: 15, question: "Which operator dereferences a pointer?", options: ["&", "*", "@", "->"], correctAnswer: 1 },
      { id: 16, question: "Which array declaration is correct?", options: ["int arr[] = 5;", "int arr[5];", "array int arr(5);", "int arr = [5];"], correctAnswer: 1 },
      { id: 17, question: "What is the default value of uninitialized local variables?", options: ["0", "Random garbage", "NULL", "Undefined"], correctAnswer: 1 },
      { id: 18, question: "What is the output of: int x = 10/3; printf(\"%d\", x);", options: ["3.3", "3", "4", "Compile error"], correctAnswer: 1 },
      { id: 19, question: "How do you write a multi-line comment?", options: ["<!-- -->", "// //", "/* */", "** **"], correctAnswer: 2 },
      { id: 20, question: "What is NULL?", options: ["0", "Nothing", "A null pointer constant", "Empty string"], correctAnswer: 2 }
    ],

    intermediate: [
      { id: 1, question: "Which memory allocation function zero-initializes the allocated block?", options: ["malloc", "calloc", "realloc", "alloc"], correctAnswer: 1 },
      { id: 2, question: "Which function frees dynamically allocated memory?", options: ["destroy()", "dispose()", "free()", "delete"], correctAnswer: 2 },
      { id: 3, question: "What is a segmentation fault?", options: ["Compiler error", "Accessing restricted memory", "Arithmetic overflow", "Syntax error"], correctAnswer: 1 },
      { id: 4, question: "Which operator accesses a struct member via a pointer?", options: [".", "->", "*", ":"], correctAnswer: 1 },
      { id: 5, question: "What does strdup() do?", options: ["Duplicates a string", "Deletes a string", "Compares strings", "Converts to uppercase"], correctAnswer: 0 },
      { id: 6, question: "Which header contains memcpy()?", options: ["<memory.h>", "<string.h>", "<stdlib.h>", "<stdio.h>"], correctAnswer: 1 },
      { id: 7, question: "What is a pointer to a function?", options: ["A pointer storing a function name", "A pointer that stores address of a function", "A function returning pointer", "A pointer inside a function"], correctAnswer: 1 },
      { id: 8, question: "If p is int*, what does p++ do?", options: ["Increments the pointed value", "Moves pointer by sizeof(int)", "Resets pointer", "Errors"], correctAnswer: 1 },
      { id: 9, question: "What does fopen return if file not found?", options: ["0", "NULL", "-1", "false"], correctAnswer: 1 },
      { id: 10, question: "Which loop guarantees at least one execution?", options: ["for", "while", "do-while", "repeat"], correctAnswer: 2 },
      { id: 11, question: "What is recursion?", options: ["Looping", "Function calling itself", "Memory leak", "Pointer arithmetic"], correctAnswer: 1 },
      { id: 12, question: "Which statement exits from a loop immediately?", options: ["exit", "stop", "break", "continue"], correctAnswer: 2 },
      { id: 13, question: "What does strcmp return when strings are equal?", options: ["0", "1", "-1", "NULL"], correctAnswer: 0 },
      { id: 14, question: "What is the storage class for global variables?", options: ["extern", "auto", "register", "static"], correctAnswer: 0 },
      { id: 15, question: "What is a static variable inside a function?", options: ["A global variable", "A variable stored in heap", "A variable that retains value between calls", "A constant"], correctAnswer: 2 },
      { id: 16, question: "What does realloc do?", options: ["Changes size of allocated memory", "Free memory", "Allocate new memory only", "Clear memory"], correctAnswer: 0 },
      { id: 17, question: "What is the type of string literals in C?", options: ["char*", "const char*", "string", "text"], correctAnswer: 1 },
      { id: 18, question: "What is undefined behavior?", options: ["Compiler warning", "Program crashes always", "No guaranteed program output", "Memory leak"], correctAnswer: 2 },
      { id: 19, question: "What will printf(\"%d\", *p) do if p is NULL?", options: ["0", "Crash (undefined behavior)", "NULL", "Warning only"], correctAnswer: 1 },
      {
        id: 20,
        question: "**Coding:** What is output?\\n```c\\nint a=5,b=2; printf(\"%d\", a++ + ++b);\\n```",
        options: ["7", "8", "9", "Undefined behavior"], correctAnswer: 1
      }
    ],

    advanced: [
      { id: 1, question: "What is undefined behavior (UB) in C?", options: ["A compiler warning", "Behavior not prescribed by the standard; anything can happen", "A runtime exception thrown by the program", "A type of syntax error"], correctAnswer: 1 },
      { id: 2, question: "What does the `restrict` qualifier indicate about a pointer?", options: ["Pointer must not be NULL", "Pointer is the only means to access the object it points to during its lifetime", "Pointer is read-only", "Pointer is volatile"], correctAnswer: 1 },
      { id: 3, question: "Which header defines `_Atomic` and atomic types in C11?", options: ["<threads.h>", "<stdatomic.h>", "<atomic.h>", "<pthread.h>"], correctAnswer: 1 },
      { id: 4, question: "What is the effect of modifying a string literal like `char *s = \"hi\"; s[0] = 'H';`?", options: ["Well-defined: string is mutable", "Undefined behavior: may crash or corrupt memory", "Compiler error", "Creates a copy and modifies it"], correctAnswer: 1 },
      { id: 5, question: "What is the meaning of 'sequence point' or sequencing in C11 memory model?", options: ["A compile-time constant", "Guarantees ordering of evaluations; modifies/reads have defined order", "A breakpoint for debugger", "A synchronization primitive for threads"], correctAnswer: 1 },
      { id: 6, question: "What is strict aliasing rule?", options: ["Any two pointers can alias safely", "Accessing an object through an incompatible pointer type (except char*) may be UB", "Pointers are always aligned", "Pointers cannot point to same memory"], correctAnswer: 1 },
      { id: 7, question: "What does `volatile` guarantee?", options: ["Atomicity of accesses", "Prevents compiler optimizations that assume value doesn't change unexpectedly", "Thread synchronization", "Initialize variable to zero"], correctAnswer: 1 },
      { id: 8, question: "Which function pair should be used to reallocate and free memory safely?", options: ["new/delete", "malloc/free", "malloc/release", "alloc/free"], correctAnswer: 1 },
      { id: 9, question: "What is a flexible array member?", options: ["Array with compile-time fixed size", "Struct member declared as `type name[];` as the last member to hold variable-sized trailing data", "Array of pointers", "Array allocated on stack only"], correctAnswer: 1 },
      { id: 10, question: "What does `offsetof(struct S, member)` return?", options: ["Size of member in bytes", "Offset (in bytes) of member within struct S", "Pointer to member", "Compile error"], correctAnswer: 1 },
      { id: 11, question: "What is a VLA (variable length array)?", options: ["Array with runtime determined size (C99 feature)", "Fixed-size array in global scope", "An array of variable pointers", "Deprecated macro"], correctAnswer: 0 },
      { id: 12, question: "What happens if you return the address of a local (stack) variable from a function?", options: ["Works reliably", "Undefined behavior due to dangling pointer", "Value copied to caller automatically", "Compiler error"], correctAnswer: 1 },
      { id: 13, question: "Which is correct to pass a string to a thread that expects `char* &` (C++ style) in C?", options: ["Pass directly", "Use pthreads and pass pointer; ensure lifetime extends until thread uses it", "Use std::thread", "Cannot pass strings to threads"], correctAnswer: 1 },
      { id: 14, question: "What is the effect of `freopen(NULL, \"w\", stdout);`?", options: ["Closes stdout", "Undefined/implementation-defined; using NULL filename is invalid", "Redirects stdout to terminal", "Sets stdout to binary mode"], correctAnswer: 1 },
      { id: 15, question: "Which of these is true about `memcpy` vs `memmove`?", options: ["Both behave identically always", "`memcpy` may be undefined for overlapping regions; `memmove` handles overlap", "`memmove` is faster and unsafe", "`memcpy` zeroes memory before copy"], correctAnswer: 1 },
      { id: 16, question: "What does `setjmp`/`longjmp` provide?", options: ["Thread synchronization", "Non-local jumps for control transfer (like exceptions)", "Atomic operations", "Memory allocation"], correctAnswer: 1 },
      { id: 17, question: "What is the problem with `char buf[10]; gets(buf);`?", options: ["No problem", "`gets` causes buffer overflow (no bounds checking) — unsafe and removed from C11", "`gets` is deprecated but safe", "It reads only 10 chars max"], correctAnswer: 1 },
      { id: 18, question: "What is the purpose of `__attribute__((packed))` (GCC extension)?", options: ["Optimize code size", "Remove padding between struct members (may cause unaligned accesses)", "Make struct immutable", "Align struct to cache line"], correctAnswer: 1 },
      { id: 19, question: "What does `extern` before a function or variable mean?", options: ["Defines storage duration as automatic", "Declares identifier with external linkage (not a local definition)", "Marks as inline only", "Forces inlining"], correctAnswer: 1 },
      { id: 20, question: "What is an ABI (Application Binary Interface) compatibility concern?", options: ["Source code style", "Binary-level contract (calling convention, alignment, type sizes) needed for linking compiled modules", "A header file mismatch only", "Memory leak detection"], correctAnswer: 1 },
      { id: 21, question: "Which is true about `inline` functions in C (C99/C11)?", options: ["`inline` forces inlining always", "Linkage rules differ: `inline` vs `extern inline` vs `static inline` affect symbol emission", "`inline` is a macro", "`inline` makes functions faster always"], correctAnswer: 1 },
      { id: 22, question: "What is the effect of `static` on a function at file scope?", options: ["Gives internal linkage (name visible only within translation unit)", "Makes function inline", "Allocates function on heap", "Exports symbol to other programs"], correctAnswer: 0 },
      { id: 23, question: "When is pointer arithmetic undefined?", options: ["When moving within the same array or one past last element", "When pointing to the first element", "When you compute pointer that doesn't point into same array or one past it", "Never undefined"], correctAnswer: 2 },
      { id: 24, question: "What is the type of string literal in C?", options: ["`char *` (modifiable)", "`const char[]` (array of const char)", "`const char *` or `char[N]` with static storage — should be considered immutable", "`std::string`"], correctAnswer: 2 },
      { id: 25, question: "What is a common cause of 'undefined reference' at link time?", options: ["Typo in variable name only in source", "Missing function/variable definition in linked object/library", "A syntax error", "Wrong #include order"], correctAnswer: 1 },
      { id: 26, question: "What does `ssize_t` represent (POSIX)?", options: ["Unsigned size type", "Signed type used for byte counts or -1 on error (e.g., read/write)", "Same as size_t", "A floating point size"], correctAnswer: 1 },
      { id: 27, question: "Which C standard introduced `_Alignof` and `_Alignas`?", options: ["C89", "C99", "C11", "C17"], correctAnswer: 2 },
      { id: 28, question: "What is 'endianess' important for?", options: ["Function prototypes", "Memory layout of multi-byte values across systems (networking, file formats)", "Preprocessor macros", "Optimization only"], correctAnswer: 1 },
      { id: 29, question: "What is the issue with `printf(\"%s\", ptr);` if `ptr` is not NUL-terminated?", options: ["Prints until NUL or crash or leak (undefined behavior)", "Prints nothing", "Compiles to warning only", "Automatically zeros memory"], correctAnswer: 0 },
      { id: 30, question: "What is reentrancy and why is it important for libraries?", options: ["Code that compiles on multiple platforms", "Function safe to call concurrently or from signals; does not use static/modifiable global state", "A function that returns early", "A function that calls itself recursively"], correctAnswer: 1 },
      { id: 31, question: "Which function converts host to network byte order for 32-bit integers?", options: ["htons()", "htonl()", "ntohs()", "ntohl()"], correctAnswer: 1 },
      { id: 32, question: "What does `fopen` return on failure?", options: ["0", "NULL", "-1", "errno"], correctAnswer: 1 },
      { id: 33, question: "Which of these is true about variable argument lists (`va_list`)?", options: ["They preserve argument types automatically", "You must know/encode types or use format strings; default promotions apply", "They are type-safe", "They work only for integers"], correctAnswer: 1 },
      { id: 34, question: "What is the danger of `strcpy(dest, src)`? ", options: ["No danger", "Buffer overflow if dest not large enough", "It always zeros dest first", "Copies only first N bytes automatically"], correctAnswer: 1 },
      { id: 35, question: "What is the purpose of `pthreads` `pthread_mutex_lock`/`unlock`?", options: ["Memory allocation", "Thread synchronization to protect shared data", "I/O multiplexing", "Process forking"], correctAnswer: 1 },
      { id: 36, question: "What is a data race in multithreaded C and its consequence?", options: ["Two threads execute same code", "Concurrent unsynchronized conflicting accesses to same memory where at least one is a write — undefined behavior", "Threads running at different speeds", "A debug-only issue"], correctAnswer: 1 },
      { id: 37, question: "Which is a safe pattern to reallocate a pointer and avoid leaks?", options: ["p = realloc(p, newsize); // ok always", "tmp = realloc(p, newsize); if (tmp) p = tmp; else /* handle error */", "free(p); p = malloc(newsize);", "Use strcpy after realloc"], correctAnswer: 1 },
      { id: 38, question: "What does `ld` linker 'undefined reference' usually indicate?", options: ["Syntax error", "Missing object file or library at link-time that defines the symbol", "Runtime error", "Preprocessor failure"], correctAnswer: 1 },
      { id: 39, question: "What is the typical safe way to parse an integer from string avoiding overflow and detecting errors?", options: ["atoi()", "strtol() or strtoll() checking endptr and errno", "sscanf(\"%d\") without checks", "Use manual loop only"], correctAnswer: 1 },
      { id: 40, question: "**Advanced Coding:** What is the behavior of the program?\\n```c\n#include <stdio.h>\nint main(void) {\n    int x = 1;\n    int *p = &x;\n    p += 1;            /* pointer arithmetic past single-object */\n    *p = 5;            /* dereference invalid pointer */\n    printf(\"%d\\n\", x);\n}\n```", options: ["Prints 1 reliably", "Prints 5 reliably", "Undefined behavior (may crash or corrupt memory)", "Compilation error"], correctAnswer: 2 }
    ]
  },
