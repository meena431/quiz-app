...
import { sidebarStyles } from '../assets/styles';
import questionsData from '../assets/data.js';
...
const Sidebar = () => {
    ...
    // the function will handle what you select the tech
    ...
    const toggleSidebar = () => setIsSidebarOpen((prev) => !prev); // toggler sidebar for smaller screens
    ...
    const submitResult = async () => {
        ...
        const payload = {
            ...
            level: selectedLevel.charAt(0).toUpperCase() + selectedLevel.slice(1),  // "Basic" ← FIXED
    ...
    useEffect(() => {
        ...
        // Skip warnings for the next useEffect
    }, [showResults]);
                                        ...
                                        {levels.map((level) => (
                                            ...
                                            >
                                                <div className={sidebarStyles.levelButtonContent}>
                                                    <span
                                                        className={`${sidebarStyles.levelIcon} ${selectedLevel === level.id
                                                            ? "bg-white/40"
                                                            : "bg-gray-100"
                                                            }`}
                                                    >
                        ...
                        <div className={sidebarStyles.welcomeContainer}>
                            <div className={sidebarStyles.welcomeContent}>
                                ...
                                <div className="block md:hidden w-full space-y-4">
                                    ...
                                    <div className="md:flex flex-col items-center justify-center w-full space-y-3">
                                        <p className="text-center max-w-sm mx-auto text-sm font-medium text-[#DDD6FE]">
                                            <Sparkles
                                                size={14}
                                                className="inline-block mr-1.5 align-text-top shrink-0 text-[#DDD6FE]"
                                            />
                                            <span>Select any technology to begin your learning adventure!</span>
                                        </p>
                                    </div>
                                </div>
