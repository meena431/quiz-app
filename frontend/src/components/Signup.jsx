...
const Signup = () => {
    ...
    // Email validating function also validating name, email and password
    const validate = () => {
        const e = {};
                ...
                <form onSubmit={handleSubmit}>
                    <div className={signupStyles.animatedBorder}>
                        <div className={signupStyles.formContent}>
                            ...
                            <label htmlFor="" className={signupStyles.label}>
                            ...
                            {submitError && (
                                <p className={signupStyles.submitButton} role='alert'>{submitError}</p>
                            )}
